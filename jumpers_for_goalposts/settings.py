"""
Django settings for jumpers_for_goalposts project.
...
DEBUG = 'DEVELOPMENT' in os.enivron
...
WSGI_APPLICATION = 'jumpers_for_goalposts.wsgi.application'
...
if 'USE_AWS' in os.environ:
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'jumpers-for-goalposts'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'jumpersforgoalposts@example.com'
